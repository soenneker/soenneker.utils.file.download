...
public static class FileDownloadUtilRegistrar
{
    ...
    {
        services.AddFileUtilAsSingleton().AddPathUtilAsSingleton().AddHttpClientCacheAsSingleton().TryAddSingleton<IFileDownloadUtil, FileDownloadUtil>();
    ...
    {
        services.AddFileUtilAsScoped().AddPathUtilAsScoped().AddHttpClientCacheAsSingleton().TryAddScoped<IFileDownloadUtil, FileDownloadUtil>();
